...
import { ClipboardList, User, Lock, LogIn } from 'lucide-react'
          ...
          <div className="px-8 py-7">
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              <div>
                <label
                  htmlFor="username"
                  className="flex items-center gap-1.5 text-sm font-bold text-[#1A5276] mb-1.5"
                >
                  <User size={14} />
                  Usuario
                </label>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-[#1A5276]
                           hover:bg-[#154360] disabled:bg-[#7FB3D3] disabled:cursor-not-allowed
                           text-white font-bold py-3 rounded-lg transition-colors text-sm mt-1"
              >
                <LogIn size={16} />
