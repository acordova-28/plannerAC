...
export class TasksController {
  ...
  // Nota: esta ruta debe estar antes de GET tasks/:id para evitar
  // que "export" sea interpretado como un UUID.
  @UseGuards(JwtAuthGuard)
